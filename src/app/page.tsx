  ...
  return (
    <main className="max-w-4xl mx-auto p-8">
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-stone-900 dark:text-stone-50">BrewBoard</h1>
        <p className="text-stone-500 dark:text-stone-400 mt-2">Your craft beer collection</p>
      </header>

      <div className="mb-6 flex flex-wrap gap-2 items-center">
        <span className="text-sm text-stone-500 dark:text-stone-400">Min rating:</span>
          ...
          <button
            ...
            className={`px-3 py-1 text-sm rounded-full border transition-colors font-medium ${
              minRating === threshold
                ...
                : 'bg-white dark:bg-stone-900 text-stone-600 dark:text-stone-300 border-stone-300 dark:border-stone-600 hover:border-amber-400'
            }`}
          >
